		...
		<div id="center">
			...
			<form action="insert2" id="form" method="post" enctype="multipart/form-data">
				...
				<div class="form-group">
					<input type="text" class="form-control input-sm" name="board_title" placeholder="제목을 입력해주세요">
				</div>
				<br>	
				<span class="label-text">게시글 작성</span><br><br>	
				<div class="form-group">
					<textarea class="form-control form-control-content" name="board_content" placeholder="게시글을 작성해주세요"></textarea>
				</div>
