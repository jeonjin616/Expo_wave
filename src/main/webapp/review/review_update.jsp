...
<body>
	...
	<div class="main">
		...
		<form action="updateReview" method="post">
			<!-- 액션을 변경하고 메서드 추가 -->
			<input id="fsv_select" type="hidden" name="fsv_id"
				value="${param.fsv_id}"> <input type="hidden"
				name="mem_id" value="${param.mem_id}"> <input
				id="show_select" type="hidden" name="show_id"
				value="${param.show_id}">
			...
			<table class="board_detail">
				...
				<tr>
					...
					<td style="width: 220px;"><input type="file"
						name="review_image" onchange="readURL(this);" style="width: 100%;" />
						<!-- 기존의 이미지 주소를 사용하여 미리보기를 표시하십시오 --> <img id="preview"
						src="${param.review_image}"
