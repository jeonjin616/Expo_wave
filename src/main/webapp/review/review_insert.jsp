      ...
      <div class="main">
      	...
      	<%-- <% value = "${mem_id}" %> --%>
      		<table class="board_detail">
      		 <tr>
      		 	 <td>
      		 	 		<select id="select" style="width: 90px; display: inline-block;">
      			...
      			<tr class="title">
      				<td style=margin>제목</td>
      				<td><input type="text" id="title" name="review_title"></td>
      			</tr>
      			<tr>
      				<td colspan="2">
      					<textarea id="contents" name="review_content"></textarea>
      				</td>
      			</tr>
      			<tr>
      				<td>
      		...
      		<input type="submit" id="submit" value="저장" class="btn" style="float: right;">
        </form>
