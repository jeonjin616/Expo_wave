...
//	}
	...
	public String toString() {
		return "MemberVO [mem_id=" + mem_id + ", mem_name=" + mem_name + ", mem_pw=" + mem_pw + ", mem_nickname="
				+ mem_nickname + ", mem_email=" + mem_email + ", mem_birth=" + mem_birth + ", mem_zipcode="
				+ mem_zipcode + ", mem_addr1=" + mem_addr1 + ", mem_addr2=" + mem_addr2 + ", mem_phone1=" + mem_phone1
